...
public final class ItemInstance extends L2Object
{
	...
	{
		return isAugmented() ? Config.AUG_WEAPON_DROPABLE : _item.isDropable();
	}
	...
	public static ItemInstance restoreFromDb(int ownerId, ResultSet rs)
	{
		...
		int objectId, item_id, loc_data, enchant_level, custom_type1, custom_type2, manaLeft, time, count;
		ItemLocation loc;
		try
		{
