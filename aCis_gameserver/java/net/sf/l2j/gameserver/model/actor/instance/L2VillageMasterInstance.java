...
public class L2VillageMasterInstance extends L2NpcInstance
{
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		{
			player.sendMessage("Academy clan are disabled!");
			return;
			//if (cmdParams.isEmpty())
			//	return;
		...
		else if (command.startsWith("Subclass"))
		{
			...
			case 1: // Add Subclass - Initial
				...
				if (player.getTotalSubClasses() >= 6)
				{
			...
			case 6: // Change/Cancel Subclass - Choice
				...
				case 3:
					...
					break;
				case 4:
					html.setFile("data/html/villagemaster/SubClass_ModifyChoice4.htm");
					break;
				case 5:
					html.setFile("data/html/villagemaster/SubClass_ModifyChoice5.htm");
					break;
				case 6:
					html.setFile("data/html/villagemaster/SubClass_ModifyChoice6.htm");
					break;
				default:
	...
	private static final void changeClanLeader(L2PcInstance player, String target)
	{
		...
		if (player.isMounted())
		{
			player.sendMessage("You must dismount the strider to change the clan leader.");
			return;
		}
		...
		for (Siege siege : SiegeManager.getSieges())
		{
			if (siege.isInProgress())
			{
				if (siege.getAttackerClan(clan) != null || siege.getDefenderClan(clan) != null)
				{
					player.sendMessage("You are not authorized to do that during siege.");
					return;
				}
			}
		}
