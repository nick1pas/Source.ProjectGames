...
import net.sf.l2j.gameserver.model.entity.events.capturetheflag.CTFEventTeam;
...
import net.sf.l2j.gameserver.model.entity.events.teamvsteam.TvTEventTeam;
...
public class L2CubicInstance
{
	...
	public void getCubicTarget()
	{
		try
		{
			...
			// LM event targeting
			if (LMEvent.isStarted() && LMEvent.isPlayerParticipant(_owner.getObjectId()))
			{
				if (ownerTarget.getActingPlayer() != null)
				{
					L2PcInstance target = ownerTarget.getActingPlayer();
