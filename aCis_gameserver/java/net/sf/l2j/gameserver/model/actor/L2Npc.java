...
public class L2Npc extends L2Character
{
	...
	public boolean Monument_Npc_PK = false, Monument_Npc_PVP = false;
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		{
			MultisellData.getInstance().separateAndSend(command.substring(9).trim(), player, false, getCastle().getTaxRate());
		}
		else if (command.startsWith("exc_multisell"))
		{
			MultisellData.getInstance().separateAndSend(command.substring(13).trim(), player, true, getCastle().getTaxRate());
		}
