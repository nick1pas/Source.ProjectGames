	...
	public void broadcastPacket(L2GameServerPacket packet)
	{
		...
		for (L2Character character : _characterList)
		{
			...
			*/
			...
			if (character instanceof L2PcInstance && !(((L2PcInstance) character).isInsideZone(ZoneId.TOURNAMENT) && !((L2PcInstance) character).isOlympiadProtection()&& !((L2PcInstance) character).inObserverMode()) && !((L2PcInstance) character).isArenaProtection() && !((L2PcInstance) character).isArenaObserv())
				character.sendPacket(packet);
		}
	}
