...
public class Siege implements Siegable
{
	...
	private void setNextSiegeDate()
	{
		...
		{
			case 1: // Gludio
				siegeDate.set(Calendar.DAY_OF_WEEK, SiegeManager.SIEGE_DAY_GLUDIO);
				break;
			case 2: // Dion
				siegeDate.set(Calendar.DAY_OF_WEEK, SiegeManager.SIEGE_DAY_DION);
				break;
			case 3: // Giran
				siegeDate.set(Calendar.DAY_OF_WEEK, SiegeManager.SIEGE_DAY_GIRAN);
				break;
			case 4: // Oren
				siegeDate.set(Calendar.DAY_OF_WEEK, SiegeManager.SIEGE_DAY_OREN);
				break;
			case 5: // Aden
				siegeDate.set(Calendar.DAY_OF_WEEK, SiegeManager.SIEGE_DAY_ADEN);
				break;
			case 6: // Innadril/Heine
				siegeDate.set(Calendar.DAY_OF_WEEK, SiegeManager.SIEGE_DAY_INNADRIL);
				break;
			case 7: // Goddard
				siegeDate.set(Calendar.DAY_OF_WEEK, SiegeManager.SIEGE_DAY_GODDARD);
				break;
			case 8: // Rune
				siegeDate.set(Calendar.DAY_OF_WEEK, SiegeManager.SIEGE_DAY_RUNE);
				break;
			case 9: // Schuttgart
				siegeDate.set(Calendar.DAY_OF_WEEK, SiegeManager.SIEGE_DAY_SCHUTTGART);
				break;
		...
		siegeDate.add(Calendar.WEEK_OF_YEAR, SiegeManager.NEXT_SIEGE_TIME);
