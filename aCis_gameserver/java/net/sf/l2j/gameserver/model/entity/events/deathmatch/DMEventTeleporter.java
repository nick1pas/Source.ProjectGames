...
public class DMEventTeleporter implements Runnable
{
	...
	public void run()
	{
		...
		if (DMConfig.DM_EVENT_EFFECTS_REMOVAL == 0 || (DMConfig.DM_EVENT_EFFECTS_REMOVAL == 1 && (_activeChar.getTeam() == 0 || (_activeChar.isInDuel() && _activeChar.getDuelState() != Duel.DUELSTATE_INTERRUPTED))))
