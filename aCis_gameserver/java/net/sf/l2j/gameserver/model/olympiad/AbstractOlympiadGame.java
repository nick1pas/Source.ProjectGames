...
public abstract class AbstractOlympiadGame
{
	...
	protected static SystemMessage checkDefaulted(L2PcInstance player)
	{
		...
		if (CTFEvent.isPlayerParticipant(player.getObjectId()) || DMEvent.isPlayerParticipant(player.getObjectId()) || LMEvent.isPlayerParticipant(player.getObjectId()) || TvTEvent.isPlayerParticipant(player.getObjectId()) || player.isInArenaEvent())
		{
	...
	protected static final void cancelationBuff(L2PcInstance player)
	{
		// Remove Buffs
		player.stopAllEffectsExceptThoseThatLastThroughDeath();
	...
	protected abstract void cancelationBuffs();
