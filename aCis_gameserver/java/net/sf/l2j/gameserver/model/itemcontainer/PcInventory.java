...
public class PcInventory extends Inventory
{
	...
	/**
	 * Adds item enchanted in inventory and checks _adena and _ancientAdena
	 * @param process : String Identifier of process triggering this action
	 ...
	 * @return ItemInstance corresponding to the new item or the updated item in inventory
	 */
	public ItemInstance addEnchantedItem(String process, int itemId, int itemCount, int enchantLevel, L2PcInstance actor, L2Object reference)
	{
