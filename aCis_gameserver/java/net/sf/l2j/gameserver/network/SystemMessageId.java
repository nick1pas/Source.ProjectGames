...
public final class SystemMessageId
{
	 ...
	 */
	public static final SystemMessageId TIME_REQUEST_TELEPORTER;
	
	/**
	 * ID: 2167<br>
	 * Message: Your hwid has been banned, please contact staff.
	 */
	public static final SystemMessageId HWID_HAS_BEEN_BANNED;
	
	/**
	 * ID: 2168<br>
	 * Message: Your hwid has been banned, please contact staff.
	 */
	public static final SystemMessageId MULTIBOX_LIMIT_EXPIRED;
	 ...
	 * Message: $s1
	 */
	public static final SystemMessageId TVT;
	...
	static
	{
		...
		TIME_REQUEST_TELEPORTER = new SystemMessageId(2166);
		HWID_HAS_BEEN_BANNED = new SystemMessageId(2167);
		MULTIBOX_LIMIT_EXPIRED = new SystemMessageId(2168);
		EVENT = new SystemMessageId(2500);
		TVT = new SystemMessageId(2501);
