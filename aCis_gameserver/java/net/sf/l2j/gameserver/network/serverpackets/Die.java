...
public class Die extends L2GameServerPacket
{
	...
	public Die(L2Character cha)
	{
		...
		_canTeleport = !(((cha instanceof L2PcInstance)) && CTFEvent.isStarted() && CTFEvent.isPlayerParticipant(_charObjId) || TvTEvent.isStarted() && TvTEvent.isPlayerParticipant(_charObjId) || LMEvent.isStarted() && LMEvent.isPlayerParticipant(_charObjId) || DMEvent.isStarted() && DMEvent.isPlayerParticipant(_charObjId) || cha.isInArenaEvent());
		_fake = !cha.isDead();
