...
public final class RequestRestartPoint extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (CTFEvent.isStarted() && CTFEvent.isPlayerParticipant(activeChar.getObjectId()) || DMEvent.isStarted() && DMEvent.isPlayerParticipant(activeChar.getObjectId()) || LMEvent.isStarted() && LMEvent.isPlayerParticipant(activeChar.getObjectId()) || TvTEvent.isStarted() && TvTEvent.isPlayerParticipant(activeChar.getObjectId()))
			return;	

		if (!activeChar.isDead())
		{
			_log.warning("Living player [" + activeChar.getName() + "] called RequestRestartPoint packet.");
			//Util.handleIllegalPlayerAction(activeChar, "Living player [" + activeChar.getName() + "] called RequestRestartPoint packet.", Config.RESTART_PACKET_PUNISH);
			return;
		}
