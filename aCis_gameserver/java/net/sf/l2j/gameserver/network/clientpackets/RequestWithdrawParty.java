...
public final class RequestWithdrawParty extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (party.isInDimensionalRift() && !party.getDimensionalRift().getRevivedAtWaitingRoom().contains(player) || player.isInArenaEvent() || Arena3x3.getInstance().isRegistered(player) || Arena5x5.getInstance().isRegistered(player) || Arena9x9.getInstance().isRegistered(player))
