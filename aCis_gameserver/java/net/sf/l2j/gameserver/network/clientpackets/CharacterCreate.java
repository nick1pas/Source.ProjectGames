...
public final class CharacterCreate extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
	    ...
	    if (Config.CUSTOM_START_LVL > 1)
	        newChar.getStat().addLevel((byte)(Config.CUSTOM_START_LVL - 1));

		if (Config.CUSTOM_STARTER_ITEMS_ENABLED)
		{
			if (newChar.isMageClass() || newChar.getClassId() == ClassId.orcMage)
			{
			...
			else if (!(newChar.getClassId() == ClassId.orcMage))
			{
