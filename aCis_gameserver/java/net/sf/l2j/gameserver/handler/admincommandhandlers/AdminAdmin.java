		...
		else if (command.startsWith("admin_reload"))
		{
			...
			try
			{
				...
				else if (type.startsWith("balance"))
				{
					...
					activeChar.sendMessage("Balance have been reloaded.");
				}
			...
			{
				activeChar.sendMessage("Usage : //reload <acar|announcement|config|crest|door|hwidbans>");
				activeChar.sendMessage("Usage : //reload <htm|item|multisell|npc|npcwalker|quest>");
				activeChar.sendMessage("Usage : //reload <scripts|skill|teleport|zone|fakenpc|skip>");
				activeChar.sendMessage("Usage : //reload <balance>|<fakeplayer>");
			}
		}
