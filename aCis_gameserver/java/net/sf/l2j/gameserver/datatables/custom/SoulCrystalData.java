 ...
 * <ul>
 * <li>SoulCrystal : infos related to items (such as level, initial / broken / succeeded itemId) ;</li>
 * <li>LevelingInfo : infos related to NPCs (such as absorb type, chances of fail/success, if the item cast needs to be done and the list of allowed crystal levels).</li>
 * </ul>
 */
public class SoulCrystalData extends XMLDocument
{
	private final static Logger _log = Logger.getLogger(SoulCrystalData.class.getName());
	...
	protected void load()
	{
		...
		_log.info("Loaded " + _soulCrystals.size() + " Soul Crystals data and " + _levelingInfos.size() + " NPCs data.");
	}
