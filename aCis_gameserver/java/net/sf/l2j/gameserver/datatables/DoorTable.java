...
public class DoorTable
{
	...
	private void onStart()
	{
		try
		{
			...
			// Beast Farm
			getDoor(21150005).openMe();
			getDoor(21150006).openMe();
			getDoor(21150007).openMe();
			getDoor(21150008).openMe();
			getDoor(21150009).openMe();
			// Castle
			getDoor(25170005).openMe();
			getDoor(25170006).openMe();
			getDoor(25170004).openMe();
			getDoor(25170003).openMe();
			getDoor(25170001).openMe();
			getDoor(25170002).openMe();
