...
public class SiegeManager
{
	...
	public static int SIEGE_DAY_SCHUTTGART;
	...
	protected SiegeManager()
	{
		...
		SIEGE_DAY_GLUDIO = sieges.getProperty("SiegeDayGludio", 0);
		SIEGE_DAY_DION = sieges.getProperty("SiegeDayDion", 0);
		SIEGE_DAY_GIRAN = sieges.getProperty("SiegeDayGiran", 0);
		SIEGE_DAY_OREN = sieges.getProperty("SiegeDayOren", 0);
		SIEGE_DAY_ADEN = sieges.getProperty("SiegeDayAden", 0);
		SIEGE_DAY_INNADRIL = sieges.getProperty("SiegeDayInnadril", 0);
		SIEGE_DAY_GODDARD = sieges.getProperty("SiegeDayGoddard", 0);
		SIEGE_DAY_RUNE = sieges.getProperty("SiegeDayRune", 0);
		SIEGE_DAY_SCHUTTGART = sieges.getProperty("SiegeDaySchuttgart", 0);

		NEXT_SIEGE_TIME = sieges.getProperty("NextSiegeTime", 2);
		...
		TELEPORT_TO_SIEGE_TOWN = sieges.getProperty("AllowTeleportToSiegeTown", false);
