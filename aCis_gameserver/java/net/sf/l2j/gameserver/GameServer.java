...
import net.sf.l2j.gameserver.model.entity.events.AutoVoteReward;
...
import net.sf.l2j.gameserver.model.entity.events.partyfarm.PartyFarmEvent;
...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		if (Config.PARTY_EVENT_START)
		{
			Util.printSection("Party Farm");
