...
public final class Tutorial extends Quest
{
	...
	public Tutorial(int questId, String name, String descr)
	{
						...
						switch (playerLevel)
						{
							...
							case 19:
								if (st.getInt("lvl") < 19)
								{
									...
									{
										if (Util.contains(FIRST_CLASSES_ID, classId))
										{
											st.playSound("ItemSound.quest_tutorial");
											st.set("lvl", "19");
							...
							case 35:
								if (st.getInt("lvl") < 35)
								{
									...
									{
										if (Util.contains(SECOND_CLASSES_ID, classId))
										{
											st.playSound("ItemSound.quest_tutorial");
											st.set("lvl", "35");
