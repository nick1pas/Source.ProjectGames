...
public class Antharas extends AbstractNpcAI
{
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		if (!Config.FWA_FIXTIMEPATTERNOFANTHARAS.isEmpty())
		{
			if (npc.getNpcId() == _antharasId)
			{
				...
				startQuestTimer("antharas_unlock", getRespawnInterval(), null, null, false);
	...
	private static long getRespawnInterval()
	{
		...
		{
			throw new RuntimeException("Invalid respawn data \"" + Config.FWA_FIXTIMEPATTERNOFANTHARAS + "\" in " + Antharas.class.getSimpleName(), ipe);
		}
	}
