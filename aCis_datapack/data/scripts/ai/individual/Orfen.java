...
public class Orfen extends AbstractNpcAI
{
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		if (!Config.FWA_FIXTIMEPATTERNOFORFEN.isEmpty())
		{
			...
			startQuestTimer("orfen_unlock", getRespawnInterval(), null, null, false);
	...
	private static long getRespawnInterval()
	{
		...
		{
			throw new RuntimeException("Invalid respawn data \"" + Config.FWA_FIXTIMEPATTERNOFORFEN + "\" in " + Orfen.class.getSimpleName(), ipe);
		}
	}
