...
public class Core extends AbstractNpcAI
{
	...
	public Core(String name, String descr)
	{
		...
		if (status == DEAD)
		{
			...
			else
			{
				...
				final L2GrandBossInstance core = (L2GrandBossInstance) addSpawn(CORE, 17726, 108915, -6520, 0, false, 0, false);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		if (!Config.FWA_FIXTIMEPATTERNOFCORE.isEmpty())
		{
			if (npc.getNpcId() == CORE)
			{
				...
				startQuestTimer("core_unlock", getRespawnInterval(), null, null, false);
	...
	private static long getRespawnInterval()
	{
		...
		{
			throw new RuntimeException("Invalid respawn data \"" + Config.FWA_FIXTIMEPATTERNOFCORE + "\" in " + Core.class.getSimpleName(), ipe);
		}
	}
