...
public class RisingShirt extends Quest
{
	...
	//private static final int BLESSED_CORE = 29006;
	
	// Items
	private static final int LIFE_ESSENCE = 9508;
	private static final int RISING_SHIRT = 9621;
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		if (npcId == SBLESSED_ANTHARAS)
		{
			if (player.isInParty())
			{
				...
				for (L2PcInstance member : party)
				{
					...
					if (_canReward)
					{
						...
						{
							if ((member.getInventory().getInventoryItemCount(LIFE_ESSENCE, 0) >= 40) && (member.getInventory().getInventoryItemCount(RISING_SHIRT, -1, true) >= 1))
							{
								member.getInventory().destroyItemByItemId("Life Essence", LIFE_ESSENCE, 40, member, null);
								member.getInventory().destroyItemByItemId("Rising Shirt", RISING_SHIRT, 1, member, null);
								member.sendMessage("40 Life Essence and 1 Fusion Rising Shirt was consumed.");
								member.addItem("Blessed Rising Shirt", 9622, 1, member, true);
			...
			else
			{
				if (Rnd.get(100) < BLESSED_CHANCE)
				{
					if ((player.getInventory().getInventoryItemCount(LIFE_ESSENCE, 0) >= 40) && (player.getInventory().getInventoryItemCount(RISING_SHIRT, -1, true) >= 1))
					{
						player.getInventory().destroyItemByItemId("Life Essence", LIFE_ESSENCE, 40, player, null);
						player.getInventory().destroyItemByItemId("Rising Shirt", RISING_SHIRT, 1, player, null);
						player.sendMessage("40 Life Essence and 1 Fusion Rising Shirt was consumed.");
						player.addItem("Blessed Rising Shirt", 9622, 1, player, true);
